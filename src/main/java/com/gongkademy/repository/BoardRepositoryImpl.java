...
public class BoardRepositoryImpl implements BoardRepository{
    ...
    @Override
    public List<Board> findByBoardKeyword(BoardCategory boardCategory, String keyword,int page) {
        // category내에서 board의 title과 body에 keyword가 포함된 board중 해당 page를 반환한다.
        em.createQuery("SELECT b FROM Board b WHERE b.boardCategory = :boardCategory AND (b.title LIKE :keyword OR b.body LIKE :keyword) AND b.isDeleted = false ORDER BY b.createdAt DESC",Board.class)
